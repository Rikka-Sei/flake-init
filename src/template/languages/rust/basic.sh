...
_template_rust_basic_init_i18n() {
    I18N_EN+=(
        ...
        ["rust_generating_gitignore"]="Creating .gitignore..."
    ...
    I18N_ZH+=(
        ...
        ["rust_generating_gitignore"]="正在创建 .gitignore..."
    )
}
_template_rust_basic_init_i18n
...
template_rust_basic_generate() {
    ...
    selected_files=$(ui_checklist "$(_t "rust_files_title")" "$(_t "rust_select_files")" 80 20 10 "" \
        ...
        "gitignore" ".gitignore" "ON")
    cancelThenExit
    
    # 解析选中的文件
    local create_cargo=false create_main=false create_flake=false create_toolchain=false create_envrc=false create_gitignore=false
    ...
    [[ "$create_gitignore" == true ]] && {
        debuger info "Rust" "$(_t "rust_generating_gitignore")"
